...
<link rel="stylesheet" href='<c:url value="/resources/css/bootstrap-modal.css"/>'>
<link rel="stylesheet" href='<c:url value="/resources/css/custom/custom.css"/>'>
<link rel="stylesheet" href='<c:url value="/resources/css/custom/admin_main.css"/>'>
...
<script type="text/javascript" src='<c:url value="/resources/js/lib/fastclick.min.js"/>'></script>
<script type="text/javascript" src='<c:url value="/resources/js/lib/jquery.dataTables.js"/>'></script>
<script type="text/javascript" src='<c:url value="/resources/js/lib/dataTables.bootstrap.js"/>'></script>
